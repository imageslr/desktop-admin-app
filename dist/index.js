...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_user__ = __webpack_require__(260);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_message__ = __webpack_require__(259);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getters__ = __webpack_require__(258);
...
const store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
  modules: {
    ...
    message: __WEBPACK_IMPORTED_MODULE_3__modules_message__["a" /* default */]
  },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_element_ui__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_element_ui___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_element_ui__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_index_js__ = __webpack_require__(109);
...
service.interceptors.request.use(config => {
    if (__WEBPACK_IMPORTED_MODULE_2__store_index_js__["a" /* default */].getters.token) {
        config.headers['token'] = __WEBPACK_IMPORTED_MODULE_2__store_index_js__["a" /* default */].getters.token; // 让每个请求携带token
    }
    return config;
}, error => {
...
var foreach = __webpack_require__(539);
...
var requirePromise = __webpack_require__(103);

requirePromise();

var ES = __webpack_require__(535);
var bind = __webpack_require__(65);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    routes: [{
        path: '/',
        hidden: true,
        component: resolve => __webpack_require__.e/* require */(1).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(216)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
    }, {
        path: '/login',
        hidden: true,
        component: resolve => __webpack_require__.e/* require */(1/* duplicate */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(216)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
    }, {
        path: '/dashboard',
        component: resolve => __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(73)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe),
        ...
        children: [{
            path: 'index',
            name: '首页',
            component: resolve => __webpack_require__.e/* require */(3).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(591)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
        }]
    }, {
        path: '/user',
        component: resolve => __webpack_require__.e/* require */(0/* duplicate */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(73)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe),
        name: '用户管理',
        ...
        children: [{
            path: 'wechat',
            name: '小程序用户',
            component: resolve => __webpack_require__.e/* require */(5).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(596)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
        }, {
            path: 'library',
            name: '图书馆管理员',
            component: resolve => __webpack_require__.e/* require */(6).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(595)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
        }, {
            path: 'wiki',
            name: 'Wiki系统用户',
            component: resolve => __webpack_require__.e/* require */(4).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(597)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
        }]
    }, {
        path: '/message',
        component: resolve => __webpack_require__.e/* require */(0/* duplicate */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(73)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe),
        ...
        children: [{
            ...
            component: resolve => __webpack_require__.e/* require */(2).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(594)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
        }]
    }, {
        path: '/404',
        hidden: true,
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/index.js!./nprogress.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/index.js!./nprogress.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
/* harmony export (immutable) */ __webpack_exports__["a"] = changePassword;
/* harmony export (immutable) */ __webpack_exports__["b"] = getSummary;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fetch_js__ = __webpack_require__(114);


function register(params) {
    return __WEBPACK_IMPORTED_MODULE_0__fetch_js__["a" /* default */].post('/api/wiki/users', params);
}

function login(username, password) {
    return __WEBPACK_IMPORTED_MODULE_0__fetch_js__["a" /* default */].post('/api/wiki/users/login', {
        username,
        password,
        type: 1,
        isAdmin: true
...
function getUserInfo(token) {
    return __WEBPACK_IMPORTED_MODULE_0__fetch_js__["a" /* default */].get('/api/wiki/users/info', {
        params: { token }
    });
}

// 修改密码
function changePassword(id, originPassword, newPassword) {
    return __WEBPACK_IMPORTED_MODULE_0__fetch_js__["a" /* default */].post('/api/wiki/users/password', {
        id,
        originPassword,
        newPassword
    });
...
function getSummary() {
    return __WEBPACK_IMPORTED_MODULE_0__fetch_js__["a" /* default */].get('/api/summary');
}
...
/* harmony export (immutable) */ __webpack_exports__["b"] = getMessageById;
/* harmony export (immutable) */ __webpack_exports__["c"] = getNumberOfMessages;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fetch_js__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_auth_js__ = __webpack_require__(72);




function getMessages(params) {
    return __WEBPACK_IMPORTED_MODULE_0__fetch_js__["a" /* default */].get('/api/messages/recipients/1', { params });
}

function getMessageById(id) {
    return __WEBPACK_IMPORTED_MODULE_0__fetch_js__["a" /* default */].get('/api/messages/' + id);
}

function getNumberOfMessages() {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/api/messages/recipients/1/number', { headers: { token: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_auth_js__["a" /* getToken */])() } }).then(response => {
        const res = response.data;
        if (res.code < 200 || res.code >= 300) {
            console.log(res);
            return Promise.reject(res);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__App_vue__ = __webpack_require__(212);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_nprogress__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_nprogress___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_nprogress__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_nprogress_nprogress_css__ = __webpack_require__(211);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__utils_auth_js__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__assets_iconfont_js__ = __webpack_require__(206);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__assets_iconfont_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__assets_iconfont_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_IconSvg_vue__ = __webpack_require__(213);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_IconSvg_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__components_IconSvg_vue__);
...
__webpack_require__(209).shim();
 // iconfont
 // svg 组件

__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_1_element_ui___default.a);
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].component('icon-svg', __WEBPACK_IMPORTED_MODULE_10__components_IconSvg_vue___default.a);

// 每隔一定时间查询消息数量
setInterval(() => {
    if (__WEBPACK_IMPORTED_MODULE_7__store__["a" /* default */].getters.token) {
        __WEBPACK_IMPORTED_MODULE_7__store__["a" /* default */].dispatch("GET_MESSAGE_NUMBERS");
    }
}, 5000);

__WEBPACK_IMPORTED_MODULE_6__router__["a" /* default */].beforeEach((to, from, next) => {
    __WEBPACK_IMPORTED_MODULE_4_nprogress___default.a.start();
    // 如果已经登录
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__utils_auth_js__["a" /* getToken */])()) {
        // 如果没有获取用户信息，则获取用户信息
        if (__WEBPACK_IMPORTED_MODULE_7__store__["a" /* default */].getters.id == '') {
            __WEBPACK_IMPORTED_MODULE_7__store__["a" /* default */].dispatch('GET_INFO').then(() => {
                next();
            }).catch(() => {
                __WEBPACK_IMPORTED_MODULE_1_element_ui___default.a.Message.error("获取用户信息失败，请刷新重试");
...
__WEBPACK_IMPORTED_MODULE_6__router__["a" /* default */].afterEach(() => {
    __WEBPACK_IMPORTED_MODULE_4_nprogress___default.a.done(); // 结束Progress
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_message__ = __webpack_require__(215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_notify_js__ = __webpack_require__(261);
...
const message = {
    ...
    mutations: {
        ...
        SET_MESSAGE_NUMBERS: (state, messageNumbers) => {
            // 未读邮件增加时发送通知
            state.messageNumbers.filter((i, index) => i.unReadTotal < messageNumbers[index].unReadTotal).map(i => i.senderType).map(i => __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_notify_js__["a" /* default */])(i));
        ...
        SET_MESSAGE_NUMBER_BY_TYPE: (state, obj) => {
            ...
            if (state.messageNumbers[obj.senderType - 1].unReadTotal < obj.unReadTotal) {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_notify_js__["a" /* default */])(obj.senderType);
            }
            __WEBPACK_IMPORTED_MODULE_1_vue__["default"].set(state.messageNumbers, obj.senderType - 1, obj);
        },
    ...
    actions: {
        ...
        GET_MESSAGE_NUMBERS({ commit, state }) {
            return new Promise((resolve, reject) => {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_message__["c" /* getNumberOfMessages */])().then(response => {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_index__ = __webpack_require__(214);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_auth__ = __webpack_require__(72);
...
const user = {
    state: {
        id: '',
        nickname: '',
        token: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_auth__["a" /* getToken */])()
    },
    ...
    actions: {
        ...
        LOGIN({ commit }, params) {
            ...
            return new Promise((resolve, reject) => {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_index__["c" /* login */])(email, params.password).then(response => {
                    commit('SET_ID', response.id);
                    commit('SET_NICKNAME', response.nickname);
                    commit('SET_TOKEN', response.token);
                    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_auth__["b" /* setToken */])(response.token);
                    resolve();
                }).catch(error => {
                    reject(error);
                });
        ...
        GET_INFO({ commit, state }) {
            return new Promise((resolve, reject) => {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_index__["d" /* getUserInfo */])(state.token).then(response => {
                    commit('SET_ID', response.id);
                    commit('SET_NICKNAME', response.nickname);
                    resolve();
                }).catch(error => {
        ...
        LOGOUT({ commit }) {
            return new Promise(resolve => {
                commit('LOG_OUT');
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_auth__["c" /* removeToken */])();
                resolve();
            });
        }
    }
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = notifyMessage;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_element_ui__ = __webpack_require__(45);
...
function notifyMessage(type) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_element_ui__["Notification"].info({
        title: '提示',
...
// module
exports.push([module.i, "#nprogress{pointer-events:none}#nprogress .bar{background:#29d;position:fixed;z-index:1031;top:0;left:0;width:100%;height:2px}#nprogress .peg{display:block;position:absolute;right:0;width:100px;height:100%;box-shadow:0 0 10px #29d,0 0 5px #29d;opacity:1;-webkit-transform:rotate(3deg) translateY(-4px);transform:rotate(3deg) translateY(-4px)}#nprogress .spinner{display:block;position:fixed;z-index:1031;top:15px;right:15px}#nprogress .spinner-icon{width:18px;height:18px;box-sizing:border-box;border:2px solid transparent;border-top-color:#29d;border-left-color:#29d;border-radius:50%;-webkit-animation:nprogress-spinner .4s linear infinite;animation:nprogress-spinner .4s linear infinite}.nprogress-custom-parent{overflow:hidden;position:relative}.nprogress-custom-parent #nprogress .bar,.nprogress-custom-parent #nprogress .spinner{position:absolute}@-webkit-keyframes nprogress-spinner{0%{-webkit-transform:rotate(0deg)}to{-webkit-transform:rotate(1turn)}}@keyframes nprogress-spinner{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}", ""]);
...
// module
exports.push([module.i, ".svg-icon[data-v-29c45fb0]{width:1em;height:1em;vertical-align:-.15em;fill:currentColor}", ""]);
...
// module
exports.push([module.i, "*{box-sizing:border-box}#app,body,html{width:100%;height:100%}#app{position:relative}body{margin:0;padding:0;min-width:950px}a{color:#37a;text-decoration:none;cursor:pointer}a:active,a:hover{color:#20a0ff}small{color:#475669}.el-menu{border-radius:0}", ""]);
...
var $isFinite = __webpack_require__(179);
var MAX_SAFE_INTEGER = Number.MAX_SAFE_INTEGER || Math.pow(2, 53) - 1;

var assign = __webpack_require__(178);
var sign = __webpack_require__(182);
var mod = __webpack_require__(181);
var isPrimitive = __webpack_require__(536);
var toPrimitive = __webpack_require__(538);
...
var ES5 = __webpack_require__(534);

var hasRegExpMatcher = __webpack_require__(543);
...
var ES2015 = __webpack_require__(532);
var assign = __webpack_require__(178);
...
var isPrimitive = __webpack_require__(183);
var isCallable = __webpack_require__(102);
var isDate = __webpack_require__(542);
var isSymbol = __webpack_require__(544);
...
var toStr = Object.prototype.toString;
var slice = Array.prototype.slice;
var isArgs = __webpack_require__(548);
...
module.exports = __webpack_require__.p + "assets/element-icons.ttf";
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(112)("103eb88b", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(112)("25535a68", content, true);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_js_cookie__ = __webpack_require__(546);
...
function getToken() {
  return __WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.get(TokenKey, { path: 'admin' });
}

function setToken(token) {
  return __WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.set(TokenKey, token, { path: 'admin' });
}

function removeToken() {
  return __WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.remove(TokenKey, { path: 'admin' });
}
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(549)))

/***/ })

},[257]);
//# sourceMappingURL=index.js.map?cf968d3e83b2fa697e2d